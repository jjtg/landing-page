...
function GdprModal({ seeCustomerAgreement, setSeeCustomerAgreement }: Props) {
  return (
    <div>
      <Modal
        isOpen={seeCustomerAgreement}
        onClose={() => setSeeCustomerAgreement(false)}
        size="xl"
      >
        <ModalOverlay />
        <ModalContent>
          ...
          <ModalBody>
            <p>
              At RedEyeMedia, accessible at RedEyeMedia.io, one of our main
              priorities is the privacy of our visitors. This Privacy Policy
              document contains types of information that is collected and
              recorded by RedEyeMedia and how we use it. If you have additional
              questions or require more information about our Privacy Policy, do
              not hesitate to contact us through email at
              redeyeprogramming@gmail.com This privacy policy applies only to
              ...
              RedEyeMedia. This policy is not applicable to any information
              collected offline or via channels other than this website. Consent
              By using our website, you hereby consent to our Privacy Policy and
              agree to its terms. Information we collect The personal
              ...
              Account, we may ask for your contact information, including email
              address. How we use your information We use the information we
              collect in various ways, including to: Provide, operate, and
              maintain our website Send you emails Third-Party Privacy Policies
              ...
              respective websites. GDPR Privacy Policy (Data Protection Rights)
              ...
              please contact us. Children's Information Another part of our
              priority is adding protection for children while using the
              internet. We encourage parents and guardians to observe,
              participate in, and/or monitor and guide their online activity.
              RedEyeMedia does not knowingly collect any Personal Identifiable
          ...
          <ModalFooter>
            <Button
              colorScheme="blue"
              mr={3}
              onClick={() => setSeeCustomerAgreement(false)}
            >
              Agree and proceed
            </Button>
...
interface Props {
  seeCustomerAgreement: boolean;
  setSeeCustomerAgreement: (seen: boolean) => void;
}
